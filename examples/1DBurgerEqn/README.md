...
One can generate the following datasets for training and testing:
  ...
  - A training and testing set`: 21 x 21 parameter cases on the given parameter space; a dataset of discrete parameter space for adaptive greedy sampling and evaluation
